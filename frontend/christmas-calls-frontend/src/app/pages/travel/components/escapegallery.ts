...
@Component({
  ...
  template: ` <div class="container mt-24 lg:mt-64">
    <div
      class="min-h-216 lg:min-h-176 relative rounded-3xl lg:rounded-4xl overflow-hidden shadow-blue-card lg:py-0"
    >
      <img
        class="object-cover -z-2 w-full h-full min-h-216 lg:min-h-176"
      ...
      >
        ...
        <div class="mt-auto mb-0 hidden lg:flex items-center gap-6">
          <button
            class="w-22 h-12 border hover:cursor-pointer border-white/12 backdrop-blur-[48px] rounded-full bg-white/12 shadow-[0px_10px_10px_-8px_rgba(18,18,23,0.02),0px_2px_2px_-1.5px_rgba(18,18,23,0.02),0px_1px_1px_-0.5px_rgba(18,18,23,0.02)]"
            (click)="handlePrev()"
          >
      ...
      <div class="absolute lg:left-106 lg:bottom-16 lg:mt-0 bottom-32">
        <ui-carousel
          #carouselRef
          [hideButtons]="true"
          [hideMask]="true"
      ...
      >
        <button
          class="w-22 h-12 border border-white/12 backdrop-blur-[48px] rounded-full bg-white/12 shadow-[0px_10px_10px_-8px_rgba(18,18,23,0.02),0px_2px_2px_-1.5px_rgba(18,18,23,0.02),0px_1px_1px_-0.5px_rgba(18,18,23,0.02)]"
          (click)="handlePrev()"
        >
          <i class="pi pi-arrow-left text-surface-0 text-xl!"></i>
        </button>
