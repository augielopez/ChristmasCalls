    ...
    <animated-container className="w-full overflow-hidden pb-6">
      ...
      >
        ...
        <div class="mt-14 mb-0 hidden lg:flex items-center gap-6">
          <button
            class="w-22 h-12 hover:cursor-pointer shadow-stroke dark:shadow-none border-0 dark:border border-white/12 rounded-full"
            (click)="handlePrev()"
          >
        ...
        <div
          class="w-full overflow-hidden lg:absolute lg:left-120 lg:top-34 mt-10 lg:mt-0 pl-12 lg:pl-0"
        >
          <div
        ...
        <div class="flex items-center justify-center lg:hidden gap-6 mt-10">
          <button
            class="w-22 h-12 shadow-stroke dark:shadow-none border-0 dark:border border-white/12 rounded-full"
            (click)="handlePrev()"
          >
            <i class="pi pi-arrow-left text-xl!"></i>
          </button>
