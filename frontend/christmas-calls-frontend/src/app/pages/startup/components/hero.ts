        ...
        >
          <div class="relative z-10">
            ...
            <div class="lg:mt-24 lg:ml-20 px-6 pt-10 lg:px-0 lg:pt-0">
              ...
              <p
                class="text-base lg:text-xl text-white/64 mt-6 max-w-120 lg:text-left text-center mx-auto lg:mx-0"
              >
                Join us to transform groundbreaking ideas into reality and drive
                the next wave of innovation.
              </p>
              <div
                class="mt-8 mx-auto lg:mx-0 pl-6 py-2 pr-2 rounded-full bg-white/1 backdrop-blur-lg flex items-center gap-2 max-w-108 border border-white/12"
              >
                <input
                  pInputText
                  type="text"
          ...
          <div class="absolute -right-168 -bottom-144 z-0">
            <circle-pattern className="w-6xl lg:w-7xl -rotate-45" />
          </div>
        </div>
      </div>
    </animated-container>
