...
@Component({
  ...
  template: `
    <div class="container lg:max-w-328 max-w-md mt-24 lg:mt-64">
      <div class="flex lg:flex-row flex-col items-start gap-16">
        ...
        <animated-container
          ...
          className="relative w-full lg:flex-1 rounded-4xl bg-main-gradient shadow-blue-card h-132 lg:h-204"
        >
          <img
