...
@Component({
  ...
  template: `
    <div class="container mt-24 lg:mt-64">
      <div
        class="max-w-104 mx-auto lg:max-w-6xl flex flex-col gap-24 lg:gap-64"
      >
        <div
        ...
        >
          ...
          <animated-container
            ...
            className="lg:flex-1 w-full max-w-140 h-92 lg:h-124 bg-main-gradient rounded-3xl relative lg:rounded-4xl"
          >
            <img
        ...
        >
          ...
          <animated-container
            ...
            className="w-full lg:flex-1 max-w-140 h-92 lg:h-124 bg-main-gradient rounded-3xl lg:rounded-4xl relative"
          >
            <img
              class="w-full h-auto absolute max-w-none"
