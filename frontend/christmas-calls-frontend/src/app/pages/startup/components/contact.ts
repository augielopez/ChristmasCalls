  ...
  template: `
    <div class="container mt-24 lg:mt-64 pb-24 lg:pb-16">
      ...
      >
        ...
        >
          <form
            class="space-y-4 max-w-lg mx-auto lg:w-lg p-6 lg:p-8 rounded-3xl lg:rounded-4xl shadow-blue-card dark:shadow-black-card bg-surface-0 dark:bg-surface-900"
          >
