...
@Component({
  ...
  template: `
    <animated-container className="container mt-24 lg:mt-64">
      <div
        class="bg-main-gradient shadow-black-card rounded-3xl lg:rounded-[3rem] h-192 lg:h-auto p-8 lg:p-24 relative overflow-hidden"
      >
        <circle-pattern
          class="absolute w-240 lg:right-0 lg:left-auto left-1/2 bottom-0 -translate-x-1/2 lg:translate-x-1/2 translate-y-1/2"
        />
        <div
          class="w-152 h-120 absolute lg:right-12 lg:left-auto left-1/2 -translate-x-1/2 lg:translate-x-0 bottom-0 lg:-bottom-6"
        >
          <img
