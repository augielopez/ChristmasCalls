...
@Component({
  ...
  template: `
    <div
      class="container max-w-6xl mt-24 lg:mt-64 flex flex-col gap-24 lg:gap-64"
    >
      <div
      ...
      >
        ...
        <animated-container
          ...
          className="lg:flex-1 w-full h-108 relative"
        >
          <div
          ...
          <div
            class="absolute lg:-left-16 -bottom-20 left-1/2 -translate-x-1/2 lg:translate-x-0 w-[90%] lg:w-auto max-w-96 pb-6 px-6 pt-5 shadow-blue-card dark:shadow-black-card border dark:border border-white/12 bg-surface-0 dark:bg-surface-950 rounded-3xl"
          >
            <div
      ...
      >
        ...
        <animated-container
          ...
          className="w-full lg:flex-1 h-108 relative"
        >
          <div
            class="w-full h-full rounded-4xl relative shadow-black-card overflow-hidden"
          >
