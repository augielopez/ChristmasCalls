    ...
    >
      <div class="container">
        ...
        >
          ...
          <div
            class="top-160 lg:top-120 -left-180 lg:-left-240 absolute"
          >
            <circle-pattern className="w-240 lg:w-7xl" />
          </div>
          <div
            class="top-160 lg:top-128 -right-180 lg:-right-240 absolute"
          >
            <circle-pattern className="w-240 lg:w-7xl" />
          </div>
          <img
