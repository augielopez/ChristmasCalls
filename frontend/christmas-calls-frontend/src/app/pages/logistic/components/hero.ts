...
@Component({
  ...
  template: `
    <animated-container
      [className]="isWide() ? 'h-200 lg:h-176 relative' : 'pt-6'"
    >
      ...
      <div class="container">
        <div
          class="h-200 lg:h-176 relative overflow-hidden rounded-3xl lg:rounded-4xl shadow-black-card flex flex-col"
        >
          <ng-container *ngIf="!isWide()">
            <img
              class="w-full h-full object-cover absolute inset-0 -z-2"
          ...
          <div class="flex-1 flex flex-col justify-between pb-16">
            <div class="mt-10 lg:mt-20 lg:ml-20 px-6 lg:px-0">
              ...
              <p
                class="mt-6 description max-w-160 text-white/72 lg:text-base text-lg"
              >
