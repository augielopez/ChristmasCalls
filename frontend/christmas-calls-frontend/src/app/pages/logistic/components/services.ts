...
@Component({
  ...
  template: `
    <div class="container relative mt-64">
      <div
        class="h-180 absolute left-2 right-2 rounded-4xl shadow-black-card overflow-hidden"
      >
        <div
      ...
      <div class="pt-20">
        ...
        <div
          class="mt-16 relative z-1 max-w-280 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-px mx-auto shadow-blue-card dark:shadow-black-card dark:bg-surface-800 bg-surface-200 rounded-4xl overflow-hidden"
        >
          <animated-container
      ...
      <div>
        <img
          class="w-full h-auto max-w-6xl mx-auto"
