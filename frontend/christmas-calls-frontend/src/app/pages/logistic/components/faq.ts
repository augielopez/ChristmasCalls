...
@Component({
  ...
  template: `
    <div class="container mt-64 flex md:flex-row flex-col gap-16">
      <div class="flex-1">
        ...
        <p
          class="text-xl text-surface-500 dark:text-white/64 mt-6 max-w-108"
        >
      ...
      <div
        class="w-full md:flex-1 h-120 md:h-200 rounded-4xl overflow-hidden relative shadow-blue-card"
      >
        <img
  ...
  styles: `
    ...
    :host-context(.dark) ::ng-deep .p-accordioncontent-content {
