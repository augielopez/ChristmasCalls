      ...
      <div class="container">
        ...
        >
          <div class="relative z-20">
            ...
            <p
              class="text-base lg:text-xl text-white/64 max-w-[calc(100%-3rem)] lg:max-w-176 mx-auto text-center mt-8"
            >
              We’re here to assist you with any questions or concerns—reach out
              to our dedicated support team anytime.
            </p>
            <form
              class="mt-16 max-w-[calc(100%-3rem)] lg:max-w-2xl mx-auto p-8 rounded-2xl lg:rounded-4xl bg-white/4 backdrop-blur-[48px] border border-white/8 shadow-[0px_2px_5px_0px_rgba(255,255,255,0.06)_inset,0px_12px_20px_0px_rgba(0,0,0,0.06)]"
            >
          ...
          <div class="absolute inset-0 overflow-hidden hidden lg:block">
            <circle-pattern
              className="absolute w-344 -bottom-full -translate-y-[32%] left-1/2 -translate-x-1/2"
            />
          </div>
        </div>
      </div>
