  ...
  template: `
    <div class="container mt-24 lg:mt-64">
      <div>
        ...
        <div
          class="mt-16 relative h-140 rounded-4xl shadow-blue-card overflow-hidden"
        >
          <img
      ...
      <div class="flex flex-col gap-24 lg:gap-36 mt-28">
        ...
        >
          <div
            class="lg:flex-1 w-full h-140 rounded-4xl shadow-blue-card overflow-hidden relative"
          >
            <img
              class="object-cover w-full h-full"
              [src]="item.image"
          ...
          <div
            class="w-full lg:flex-1 flex flex-col justify-between gap-4 lg:min-h-124 h-full"
          >
