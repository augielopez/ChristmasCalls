    ...
    <div class="container mt-24 lg:mt-64">
      ...
      <div class="mt-14 flex flex-col">
        ...
        >
          ...
          >
            <div
              class="w-92 flex-1 lg:flex-none text-4xl font-semibold text-surface-950 dark:text-surface-0 group-hover:text-surface-0 dark:group-hover:text-surface-950 transition-colors"
            >
              {{ item.title }}
            </div>
            <div class="lg:block hidden relative w-100 h-full">
              <div
              ...
              <div
                class="flex items-center gap-2 absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-all mask-[linear-gradient(to_right,transparent_0,black_100px,black_calc(100%-100px),transparent_100%)]"
              >
                <div
