...
@Component({
  ...
  template: `
    <animated-container className="container mt-64">
      <div
        class="flex items-center justify-center h-84 lg:h-180 relative rounded-4xl overflow-hidden px-4"
      >
        <div
        ...
        />
        <div class="max-w-[16rem] lg:max-w-152">
          <h1 class="title text-3xl lg:text-7xl">
            Begin Your Home Journey Today
          </h1>
          <p class="text-lg text-white/72 max-w-md mt-6">
