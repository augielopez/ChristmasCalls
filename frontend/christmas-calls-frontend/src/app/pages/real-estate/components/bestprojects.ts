  ...
  template: `
    <div class="mt-24 lg:mt-64 container">
      <div class="w-full flex flex-wrap items-start justify-between gap-6">
        <h1
          class="max-w-xl text-3xl lg:text-6xl font-semibold text-surface-950 dark:text-surface-0 leading-tight"
        >
      ...
      <div class="mt-14 grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        >
          <div
            class="group relative h-136 rounded-3xl overflow-hidden shadow-blue-card dark:shadow-none border-0 dark:border border-white/12"
          >
            <img
