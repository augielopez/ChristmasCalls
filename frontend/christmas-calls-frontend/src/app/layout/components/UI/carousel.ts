...
@Component({
  ...
  template: `
    ...
    >
      ...
      >
        <button
          class="w-32 h-12 rounded-full flex items-center justify-center shadow-stroke dark:shadow-black-card border-0 dark:border border-white/12 cursor-pointer"
          type="button"
