...
@Component({
  ...
  template: `
    <animated-container>
      ...
      >
        <circle-pattern
          className="absolute -top-1/2 left-1/2 -translate-x-1/2 translate-y-144 lg:-translate-y-22 rotate-180 w-200 lg:w-328 opacity-40 "
        />
        <div
          class="mb-20 pb-36 pt-16 flex items-center justify-center border-b border-white/10 border-dashed"
        >
          <div class="max-w-136 mx-auto">
            <h1
            ...
            <p
              class="text-lg lg:text-xl text-white/64 text-center max-w-100 mx-auto mt-6"
            >
        ...
        <p-avatar
          ...
          shape="circle"
        />
        <div class="lg:block hidden absolute left-88 top-112">
          <span
            class="absolute w-[110%] aspect-square left-1/2 -translate-x-1/2 top-1/2 -translate-y-[56%] rounded-full backdrop-blur-[2px] bg-white/4 z-10"
          ></span>
          <p-avatar
        ...
        <div
          class="lg:block hidden absolute left-[calc(100%-24rem)] top-104"
        >
          <span
            class="absolute w-[110%] aspect-square left-1/2 -translate-x-1/2 top-1/2 -translate-y-[56%] rounded-full backdrop-blur-[2px] bg-white/4 z-10"
          ></span>
